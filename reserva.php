                     ...
                     <div class="col-md-12">
                        ...
                        <details id="ida" open>
                           ...
                           <div class="row">
                              ...
                              <div class="col-md-4"><label for="">Fecha/Hora Recogida</label>
                                 <input type="text" id="ida_hora" name="ida_hora" class="form-control ida time">
                              </div><br>
                              <div class="col-md-4">
                              </div><br>
                              <!--VALOR IDA-->
                              <div class="col-md-4"><label for="">Valor viaje</label>
                                 <input type="text" id="ida_valor" class="form-control ida time" value="10000" readonly>
                              </div><br>
                              <p>ORIGEN</p>
                              <!--REGION ORIGEN-->
                        ...
                        <details id="vuelta" class="hidden">
                           ...
                           <div class="row">
                              <!--HORARIO-->
                              <div class="col-md-4"><label for="">Fecha/Hora Recogida</label>
                                 <input type="text" id="vuelta_ida" name="vuelta_hora" class="form-control time">
                              </div><br>
                              <div class="col-md-4">
                              </div><br>
                              <!--VALOR IDA-->
                              <div class="col-md-4"><label for="">Valor viaje</label>
                                 <input type="text" id="vuelta_valor" class="form-control time" value="10000" readonly>
                              </div><br>
                              <p>ORIGEN</p>
                              <!--REGION ORIGEN-->
                              <div class="col-md-6"><label for="">Región Origen</label>
