          ...
          <form id="filtro">
            <div class="filtro">
              <div class="row">
                ...
                <div class="col-md-4" id="rango_filtro"><label for="">Rango Precio</label>
                </div>
                <div class="col-md-4">
                  <button type="button" class="btn btn-filtro col-md-2">Filtrar</button>
                  <button type="reset" class="btn btn-filtro col-md-2" id="limpiar">Limpiar</button>
                </div>
              </div>
            </div>
          </form>
